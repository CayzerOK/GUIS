...
void UGUIS::IncreaseItemCount(UItemBase* Item, uint32 Amount)
{
    Item->Count+=Amount;
}

void UGUIS::DecreaseItemCount(UItemBase* Item, uint32 Amount)
{
    Item->Count-=Amount;
    if (Item->Count<1)
    {
...
UItemBase* UGUIS::GetItem(uint32 ItemID)
{
...
UItemBase* UGUIS::HandleStruct(FProperty* Property, void* StructPtr)
{
    uint32 ItemHash = 0;
